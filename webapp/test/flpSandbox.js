					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Outbound Delivery Factory",
									"targetURL": "#zuiodfty-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zuiodfty-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuiodfty",
									"url": sap.ui.require.toUrl("zuiodfty")
								}
							}
						}
					}
