sap.ui.define([
    ...
    return Controller.extend("zuiodfty.controller.BaseController", {
        ...
        getColumns: async function(pTableList) {
            ...
            var sPath = jQuery.sap.getModulePath("zuiodfty", "/model/columns.json")
        ...
        showLoadingDialog(pTitle) {
            if (!_this._LoadingDialog) {
                _this._LoadingDialog = sap.ui.xmlfragment("zuiodfty.view.fragments.dialog.LoadingDialog", _this);
